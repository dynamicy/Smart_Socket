/*1351602733,173217321*/

if (self.CavalryLogger) { CavalryLogger.start_js(["78b\/X"]); }
...
{popup:PlatformOptInPopup.open('login','plugin.optin')};},
...
/** js/listeners/forms/placeholder.js */
...
/** js/listeners/forms/placeholder_onsubmit.js */
...
/** js/plugins/legacy/PluginOptin.js */
__d("legacy:PluginOptin-legacy",["Plugin","PluginOptin"],function(a,b,c,d){




if(!a.Plugin||!a.Plugin.CONNECT)
a.Plugin=b('Plugin');


a.Plugin.Optin=b('PluginOptin');},

3);

/** js/connect_widget/connect_to_external_node_widget.js */
...
viewerID:a.viewer,
nodeType:a.nodeType,
viewerIsAdmin:a.viewerIsAdmin&&!a.userOptedOut,
adminUrl:a.adminUrl,
popupOptInParams:{},
nodeUri:new URI(a.nodeURL),
...
error:a.error,
errorURI:new URI('/'),
alreadyConnected:a.alreadyConnected,
usingConnectLibrary:!!a.channelURL,
commentWidgetMarkup:a.commentWidgetMarkup,
commentWidgetOpen:false,
commentWidgetVisible:false,
userProfile:null,
connectStoryFbid:0,
isAmbiguousText:a.isAmbiguousText,
socialBar:a.socialbar,
useDisconnectLink:a.useDisconnectLink,
showError:a.showError,
showConfirm:a.showConfirm,
showFaces:a.showFaces,
connectText:a.connectText,
ref:a.ref,
userOptedOut:a.userOptedOut,
usingInlineCommenting:a.usingInlineCommenting,
mobile:a.mobile,
supportCommenting:!a.mobile&&
(!!a.channelURL||a.usingInlineCommenting),
inlineCommentListenersInitialized:false,
inlineCommentFocused:false,
forceCommentHooks:a.forceCommentHooks,
nux:a.nux,
iframeReferer:a.iframeReferer,
isBlocked:a.isBlocked,
isPersonalized:a.isPersonalized,
confirmedConnect:a.confirmedConnect,
hasSend:a.send,
...
resizeWidth:
a.autoResize&&
a.layout!==ExternalNodeConnectWidget.STANDARD_LAYOUT});




this.connectButtonSlider=
DOM.scry(this.widget,'div.connect_button_slider');
this.connectButtonContainer=null;
if(this.connectButtonSlider.length){
this.connectButtonSlider=this.connectButtonSlider[0];
this.connectButtonContainer=
DOM.find(this.connectButtonSlider,'div.connect_button_container');}else 

this.connectButtonSlider=null;


this.connectButton=
DOM.find(this.widget,'a.connect_widget_like_button');
...
DOM.scry(this.widget,'span.connect_widget_connected_text');
this.connectedMessage=this.connectedMessage.length?
this.connectedMessage[0]:null;

this.notConnectedMessage=
DOM.scry(this.widget,
'span.connect_widget_not_connected_text');
this.notConnectedMessage=this.notConnectedMessage.length?
this.notConnectedMessage[0]:null;

this.adminSpans=
DOM.scry(this.widget,
'span.connect_widget_admin_span');
if(this.adminSpans.length>0){
this.adminLinks=[];
for(var b=0;b<this.adminSpans.length;b++)
this.adminLinks[b]=DOM.find(this.adminSpans[b],
'a.connect_widget_admin_option');}



if(this.layout==ExternalNodeConnectWidget.STANDARD_LAYOUT){
this.confirmationCell=
DOM.find(this.widget,'div.connect_confirmation_cell');

this.userActionTextSpan=
DOM.find(this.confirmationCell,'span.connect_widget_user_action');

this.summaryTextSpan=
DOM.find(this.confirmationCell,'span.connect_widget_summary');
this.summaryText=
DOM.find(this.confirmationCell,'div.connect_widget_text_summary');

var c=
DOM.scry(this.widget,'div.connect_widget_sample_connections');
this.sampleConnections=c.length>0?
c[0]:null;

if(a.showFaces&&a.viewer>0){
var d=
DOM.scry(this.widget,'div.connect_widget_logged_in_user');
this.loggedInUserPhotoDiv=d.length>0?
d[0]:null;}}
...
this.summaryIncluding=
DOM.find(this.widget,
...
if(this.pageId)
copyProperties(this.popupOptInParams,{connect_id:this.pageId});


this.errorSpans=DOM.scry(this.widget,
'span.connect_widget_error_span');
if(this.errorSpans.length>0){
this.errorLinks=[];
for(var e=0;e<this.errorSpans.length;e++)
this.errorLinks[e]=DOM.find(this.errorSpans[e],
'a.connect_widget_error_text');}



this.confirmSpans=DOM.scry(this.widget,
'span.connect_widget_confirm_span');
if(this.confirmSpans.length>0){
this.confirmLinks=[];
for(var f=0;f<this.confirmSpans.length;f++)
this.confirmLinks[f]=DOM.find(this.confirmSpans[f],
'a.connect_widget_confirm_link');}
...
this.unlikeLinks[g]=DOM.find(this.unlikeSpans[g],
'a.connect_widget_unlike_link');
Event.listen(this.unlikeLinks[g],
'click',
this.connectToNodeOnClick.bind(this));}
...
this.numberCloudNub=
DOM.find(this.widget,'div.connect_widget_number_cloud_nub');
this.numberCloudExtension=
DOM.find(this.numberCloud,'div.connect_widget_number_cloud_extension');
this.sizeNumberCloud();
this.numberCloudUnlikeSpan=
DOM.find(this.numberCloudExtension,
'span.unlike_span');
this.numberCloudReminderSpan=
DOM.find(this.numberCloudExtension,
'span.like_reminder');

this.inAnimation=false;
this.reminderIsVisible=
CSS.hasClass(this.numberCloudUnlikeSpan,'hidden_elem');
Event.listen(this.numberCloud,
'mouseleave',
this.restoreReminderSpan.bind(this));
Event.listen(this.numberCloudExtension,
'mouseleave',
this.restoreReminderSpan.bind(this));
Event.listen(this.numberCloudExtension,
'mouseenter',
this.exposeUnlikeSpan.bind(this));
Event.listen(this.numberCloud,
'mouseenter',
this.exposeUnlikeSpan.bind(this));
Event.listen(this.numberCloudExtension,
...
this.shareCommentSpans=
DOM.scry(this.widget,
'span.connect_widget_share_comment_span');
for(var i=0;i<this.shareCommentSpans.length;i++){
var j=
DOM.find(this.shareCommentSpans[i],
'a.connect_widget_share_comment_option');
Event.listen
(j,
'click',
function(event){
...
this.thumbsUpIcon=
DOM.find(this.summaryIncluding,
'div.thumbs_up');
this.undoRegion=
DOM.find(this.summaryIncluding,
'div.undo');
...
'mouseenter',
function(event){
this.undoButton=DOM.find(this.undoRegion,
'label.undo_button input');
Event.listen
(this.undoButton,
'click',
this.connectToNodeOnClick.bind(this));
...
if(!this.isBlocked){
Event.listen(this.connectButton,
'click',
this.primaryLikeButtonOnClick.bind(this));
if(this.grayOut)
Event.listen(this.tombstoneCross,
'click',
this.connectToNodeOnClick.bind(this));}
...
if(this.adminLinks)
for(var b=0;b<this.adminLinks.length;b++)
Event.listen(this.adminLinks[b],
'click',
this.presentAdminPage.bind(this));



if(this.errorLinks)
for(var b=0;b<this.errorLinks.length;b++)
Event.listen(this.errorLinks[b],
'click',
this.presentErrorDialog.bind(this));



if(this.confirmLinks)
for(var k=0;k<this.confirmLinks.length;k++)
Event.listen(this.confirmLinks[k],
'click',
this.presentConfirmDialog.bind(this));
...
this.widthSyncArbiter=Arbiter.subscribe
('platform/socialplugins/send/resize',
this.syncSendWidgetWidth.bind(this));


Arbiter.inform
('platform/socialplugins/like/resize',
{button_width:this.computeButtonDimensionsWithPadding().width,
widget_width:Vector2.getElementDimensions(this.widget).x,
layout:this.layout},
...
Arbiter.subscribe
('platform/socialplugins/dialog',function(l,m){
if(m.controllerID!==this.widgetID)
this.otherCommentWidgetOpen=(m.event=='open');}.
...
Arbiter.subscribe
('platform/socialplugins/dialog',function(l,m){
if(m.controllerID!==this.divID&&m.event=='open')
...
copyProperties(ExternalNodeConnectWidget,

{STANDARD_LAYOUT:'standard',
BOX_COUNT_LAYOUT:'box_count',
BUTTON_COUNT_LAYOUT:'button_count',
...
copyProperties(ExternalNodeConnectWidget.prototype,




{getSyncEndpointName:function(){
},
...
if(this.viewerID&&c.user!==this.viewerID)
document.location.reload();}.
...
copyProperties(this.popupOptInParams,
{protocol:window.location.protocol,
external_page_url:this.externalUrl});


if(this.nux)
copyProperties(this.popupOptInParams,
{nux:this.nux,
referer:this.iframeReferer});},
...
if(!b)
Arbiter.inform(this.getConnectionEndpointName(),
a,Arbiter.BEHAVIOR_STATE);
...
if(!b||c)
WidgetArbiter.inform(this.getSyncEndpointName(),
...
new Plugin.Optin('likebox').start();},
...
var b=a.getPayload();
if(b.requires_login){
this.updateWidget({nowConnected:false,
isAdmin:false},false);
this.presentOptIn();
return;}


var c={nowConnected:b.success&&
b.already_connected,
isAdmin:b.is_admin,
showError:b.show_error,
showConfirm:b.show_confirm,
adminUrl:b.admin_url,
userProfile:b.user_profile,
connectStoryFbid:b.story_fbid,
error:b.error_info};
...
this.expandedNumberCloudHeight=
this.collapsedNumberCloudHeight+this.getNumberCloudExtensionHeight();
if(this.alreadyConnected)
Style.set(this.numberCloud,
'height',
this.expandedNumberCloudHeight+'px');

var a=
this.computeButtonDimensionsWithPadding().width;
...
var a=
Vector2.getElementDimensions(this.numberCloud).y,
b=
parseInt(Style.get(this.numberCloud,'paddingTop'),10),
c=
parseInt(Style.get(this.numberCloud,'paddingBottom'),10),
d=
parseInt(Style.get(this.numberCloud,'border'),10);
return a-b-c-2;},
...
CSS.addClass(this.numberCloudExtension,
...
var a=
Vector2.getElementDimensions(this.numberCloudExtension).y;

if(!this.alreadyConnected)
CSS.addClass(this.numberCloudExtension,'hidden_elem');


CSS.removeClass(this.numberCloudExtension,
'connect_widget_offscreen');
return a;},


restoreReminderSpan:function(event){
if(this.reminderIsVisible||
this.inAnimation)
return;
...
animation(this.numberCloudReminderSpan).
to('opacity',1).
duration(100).
ondone(function(){
this.inAnimation=false;
...
animation(this.numberCloudUnlikeSpan).
to('opacity',1).
duration(100).
ondone(function(){
this.inAnimation=false;
...
this.commentButtonIsActive=
this.inlineCommentInput.value.trim().length>0;},
...
Event.kill(event);
if(!this.inlineCommentFlyoutOpen||
this.inlineCommentFlyoutVisible||
this.showConfirm||
this.error)
return;
...
if(event&&
DOM.contains(this.inlineCommentFlyout,event.getRelatedTarget()))
return;


var a=this.inlineCommentInput.value.trim(),
b=this.inlineCommentInput.getAttribute('placeholder');
if(a.length>0&&
a!=b)
...
Style.set(this.inlineCommentInput,
'width',
this.textInputWidthWithoutButton+'px');
Style.set(this.inlineCommentInput,
'margin-right',
0);},
...
var a=0,
b=this.computeButtonDimensions(),
c=b.height,
d=this.grayOut?a:a+20,
e=intl_locale_is_rtl()?'right':'left';

if(this.showFaces){
var f=
DOM.scry(this.widget,'span.connect_widget_text')[0],
g=
intl_locale_is_rtl()?'paddingRight':'paddingLeft',
h=
Style.get(f,g);
d=this.grayOut?a:
a+parseInt(h,10);
var i=
Vector2.getElementDimensions(this.sampleConnections).y;
c=i-3;}
...
var j=
Vector2.getElementDimensions(this.summaryText).y;
if(j>15)
c+=2;


Style.set(this.inlineCommentFlyout,
e,
d+'px');
Style.set(this.inlineCommentFlyout,
'top',
...
var k=Vector2.getElementPosition(this.widget,'document').x,
l=Vector2.getElementDimensions(this.widget).x,
m=k+l-d-5;
...
var n=
Vector2.getElementDimensions(this.inlineCommentButton).x;
CSS.addClass(this.inlineCommentButton,'hidden_elem');
var o=(this.inlineCommentClose)?15:0;

this.textInputWidthWithoutButton=m-24-o;
this.textInputWidthWithButton=
this.textInputWidthWithoutButton-
n-
this.textInputMarginWithButton-
1;
...
var d={href:this.externalUrl,
node_type:this.nodeType,
edge_type:this.edgeType,
page_id:this.pageId,
connect_text:this.connectText,
story_fbid:this.connectStoryFbid,
comment:a,
widget_type:c||'xfbml',
own_product:b};
...
new AsyncRequest().
setURI(this.getCommentAjaxEndpoint()).
setData(d).
setNectarModuleDataSafe().
setNectarImpressionIdSafe().
send();
...
Event.kill(event);
var a='_blank';
window.open(this.adminUrl.toString(),
a);},
...
var a='_blank',
b='toolbar=0, status=0, width=960, height=300';
window.open(this.error.errorUri.toString(),
a,
b);},
...
var a='_blank',
b=
'toolbar=0,status=0,width=450,height=200,scrollbars=0,location=0,menubar=0';
...
this.connectToNode(!this.alreadyConnected);}else 

this.updateWidget({nowConnected:this.alreadyConnected,
showConfirm:null,
isAdmin:this.viewerIsAdmin},false);},
...
this.showElementIf(this.errorSpans[c],
this.error&&(this.viewerIsAdmin||this.showError));



for(var d=0;d<this.confirmSpans.length;d++)
this.showElementIf(this.confirmSpans[d],
!this.alreadyConnected&&this.showConfirm);


for(var e=0;e<this.unlikeSpans.length;e++)
this.showElementIf(this.unlikeSpans[e],
this.alreadyConnected);


if(this.shareCommentSpans)
for(var f=0;f<this.shareCommentSpans.length;f++)
this.showElementIf(this.shareCommentSpans[f],a);



this.showElementIf(this.connectButton,
(!this.useDisconnectLink||!a)&&
!this.showConfirm);
...
if(this.layout===ExternalNodeConnectWidget.SIMPLE_LAYOUT){
this.manageSimpleButtonAnimation(a);}else 
...
this.fixIEButtonDoubleLineBug();}else{
...
this.oAnimateBlind=animation(this.connectButtonSlider).
duration(150);
...
var b=1,
c=intl_locale_is_rtl(),
d=c?'marginRight':'marginLeft',
e=c?'marginLeft':'marginRight';
...
CSS.addClass(this.confirmationCell,
'connect_confirmation_cell_like');
CSS.removeClass(this.confirmationCell,
...
DOM.replace(this.tombstoneCross,
HTML('<div class="tombstone_cross tombstone_cross_static" />'));
...
_clickLocked:false,
connectToNodeOnClick:function(event){
Event.kill(event);
if(!this._clickLocked){
this._clickLocked=true;
setTimeout(function(){this._clickLocked=false;}.bind(this),1000);
if(this.viewerID==0||this.userOptedOut){
this.presentOptIn();}else 
...
this.updateWidget({nowConnected:!this.alreadyConnected,
isAdmin:this.viewerIsAdmin},true);
var c={href:this.externalUrl,
node_type:this.nodeType,
edge_type:this.edgeType,
page_id:this.pageId,
layout:this.layout,
is_personalized:this.isPersonalized,
show_captcha:this.showCaptcha,
connect_text:this.connectText,
ref:this.ref,
now_connected:a,
iframe_referer:this.iframeReferer};
if(this.confirmedConnect)
c.confirm=1;


new AsyncRequest().
setURI(this.getAjaxEndpoint()).
setHandler(this.syncWidgetWithServer.bind(this)).
setData(c).
setNectarModuleDataSafe().
setNectarImpressionIdSafe().
send();
...
Event.listen(this.widget,
'mouseleave',
this.transitionBetweenMessages.bind(this));}
...
for(var d=0;d<this.shareCommentSpans;d++)
CSS.removeClass(this.shareCommentSpans[d],'hidden_elem');}else
...
if(!this.alreadyConnected||
CSS.hasClass(this.userActionTextSpan,
'hidden_elem'))
return;


animation(this.userActionTextSpan).
to('opacity',0).
duration(500).
ondone(function(){
CSS.addClass(this.userActionTextSpan,'hidden_elem');
...
CSS.removeClass(this.summaryTextSpan,'hidden_elem');
animation(this.summaryTextSpan).
to('opacity',1).
duration(500).
ondone(function(){
this.repositionFacepileVertically();}.
...
var a=
{type:'presentEdgeCommentDialog',
masterFrameName:window.name,
version:2},



b=Vector2.getElementDimensions(this.connectButton),
c=Vector2.getElementPosition(this.connectButton);
...
this.commentWidgetExpanded=true;}else
if(this.usingInlineCommenting)
...
this.positionInlineCommentFlyout();
this.inlineCommentListenersInitialized=true;}else{
...
var a=$('connect-widget-comment-box-markup'),
b=ExternalNodeConnectWidget.commentMarkup;
a.innerHTML=b;
this.unwrapComment.done=true;},


initializeInlineCommentListeners:function(){
this.inlineCommentFlyout=DOM.find(this.widget,
'.connect_widget_comment_box');
this.inlineCommentInput=DOM.find(this.inlineCommentFlyout,
'.connect_widget_comment_textinput');
this.inlineCommentButton=DOM.find(this.inlineCommentFlyout,
'.connect_widget_comment_button');

this.inlineCommentClose=DOM.scry(this.inlineCommentFlyout,
'.connect_widget_comment_close_button');
if(this.inlineCommentClose.length>0)
this.inlineCommentClose=this.inlineCommentClose[0];


this.commentButtonIsActive=false;
Event.listen(this.inlineCommentInput,
'keyup',
this.conditionallyActivateButton.bind(this));
Event.listen(this.inlineCommentInput,
'focus',
function(){
...
bind(this));
Event.listen(this.inlineCommentButton,
'click',
this.updateConnectionWithComment.bind(this));
Event.listen(this.inlineCommentInput,
'blur',
function(){
...
Event.listen(this.widget,
'mouseout',
this.hideInlineComment.bind(this));
Event.listen(this.widget,
'mouseover',
this.showInlineComment.bind(this));
if(this.inlineCommentClose)
Event.listen(this.inlineCommentClose,
'click',
function(event){
for(var a=0;a<this.shareCommentSpans.length;a++)
CSS.removeClass(this.shareCommentSpans[a],
'hidden_elem');
...
Style.set(this.inlineCommentInput,
'width',
this.textInputWidthWithButton+'px');
Style.set(this.inlineCommentInput,
'margin-right',
this.textInputMarginWithButton+'px');},
...
animation(this.numberCloud).
to('height',this.expandedNumberCloudHeight).
duration(100).
ondone(function(){
animation(this.numberCloudExtension).
from('opacity',0).
to('opacity',1).
duration(100).
go();}.
...
if(a&&!this.showConfirm){
this.animateButtonCountButtonDisappearance();}else 
...
if(a&&!this.showConfirm){
this.animateSimpleButtonDisappearance();}else 
...
from('opacity',1).
to('opacity',0).
from('width',this.originalButtonWidth).
to('width','0px').
ondone(function(){
CSS.addClass(this.connectButton,'hidden_elem');}.
bind(this)).
...
animation(this.numberExcluding).
from('opacity',1).
to('opacity',0).
duration(100).
ondone(function(){
...
animation(this.summaryIncluding).
from('opacity',0).
to('opacity',1).
duration(100).
go();}.
...
var b=
Vector2.getElementDimensions(this.connectButton),
c=b.x,
d=b.y,
e=
parseInt(Style.get(this.connectButton,'paddingLeft'),10),
f=
parseInt(Style.get(this.connectButton,'paddingRight'),10),
g=
parseInt(Style.get(this.connectButton,'paddingTop'),10),
h=
parseInt(Style.get(this.connectButton,'paddingBottom'),10);
...
animation(this.connectButton).
from('width','0px').
to('width',this.originalButtonWidth).
from('opacity',0).
to('opacity',1).
duration(100).
go();}
...
var b=DOM.find(this.commentDocument,
'img.connect_comment_widget_user_pic');
...
var c=DOM.scry(this.commentDocument,
'img.connect_comment_share_preview_pic');
if(c.length>0){
c=c[0];
var d=50,
e=Vector2.getElementDimensions(c),
f=d/e.x;
if(f<1){
Style.set(c,'width',d);
Style.set(c,
...
g.onmouseout=this.commentDocument.body.onmouseout=
this.onCommentMouseOut.bind(this);

g.onmouseover=this.commentDocument.body.onmouseover=
this.onCommentMouseOver.bind(this);
...
var b=DOM.find(this.connectButton,'.liketext'),


c=Vector2.getElementPosition(b).x+7,
d=DOM.find(this.commentDocument.body,'.nub');

if(intl_locale_is_rtl()){


c+=b.offsetWidth-14-7;
left=c-parseFloat(a)+d.offsetWidth/2;}else 
...
this.placeholderInputRegion=
DOM.find(a,
'div.connect_comment_widget_placeholder_input_region');

this.placeholderInput=
DOM.find(this.placeholderInputRegion,
'input.connect_comment_widget_placeholder_input');

this.fullInputRegion=
DOM.find(a,
'div.connect_comment_widget_full_input_region');

this.fullInputTextarea=
DOM.find(this.fullInputRegion,
'textarea.connect_comment_widget_full_input_textarea');

this.ownProductCheckbox=
DOM.scry(a,
'input.connect_comment_widget_own_product_checkbox');
if(this.ownProductCheckbox.length>0)
this.ownProductCheckbox=this.ownProductCheckbox[0];


this.widgetButtonRegion=
DOM.find(a,
'div.connect_comment_widget_button_region');

this.postToFacebookButton=
DOM.scry(this.widgetButtonRegion,
'.connect_comment_widget_post_button input');
...
this.closeButton=
DOM.scry(this.widgetButtonRegion,
'.connect_comment_widget_close_button input');
...
if(this.layout===ExternalNodeConnectWidget.BOX_COUNT_LAYOUT||
this.layout===ExternalNodeConnectWidget.BUTTON_COUNT_LAYOUT){
return this.widget;}else
if(this.layout===ExternalNodeConnectWidget.SIMPLE_LAYOUT){
return this.widget;}else
if(this.grayOut){

return DOM.find(this.widget,'table.connect_widget_interactive_area');}else 
...
return !this.commentWidgetIsExpanded||
...
var a=DOM.scry(window.document,'link'),
b=DOM.scry(window.document,'style'),
c=DOM.find(window.document,'html'),

d=DOM.find(this.commentDocument,'html'),
e=DOM.find(this.commentDocument,'head');

for(var f=0;f<a.length;f++)
if(a[f].rel=='stylesheet'){
...
var h=this.commentDocument.createElement('style'),
i=b[f].innerText||
b[f].textContent||
b[f].innerHTML;
...
if(CSS.hasClass(this.fullInputTextarea,
'connect_comment_widget_disabled')){
CSS.removeClass(this.fullInputTextarea,
'connect_comment_widget_disabled');
this.fullInputTextarea.value='';}
...
this.fullInputTextarea.value=this.defaultInputText;
CSS.addClass(this.fullInputTextarea,
'connect_comment_widget_disabled');}
...
var a=this.fullInputTextarea.value.trim(),
b=this.ownProductCheckbox.checked;
...
var c=this.computeButtonDimensionsWithPadding().width,
d=b.button_width-c;
...
'width',
(b.button_width-
parseInt(Style.get(this.connectButton,'paddingLeft'))-
parseInt(Style.get(this.connectButton,'paddingRight'))-
parseInt(Style.get(this.connectButton,'borderLeftWidth'))-
parseInt(Style.get(this.connectButton,'borderRightWidth')))+
'px');
...
g=intl_locale_is_rtl(),
h=g?'right':'left';

if(f&&f<9){

Style.set(this.connectButton,'position','absolute');
Style.set(this.connectButton,
h,
-(b.button_width+10)+'px');}else{
...
Style.set(this.confirmationCell,
h,
(b.button_width+c+5)+'px');
...
var a=
Vector2.getElementDimensions(this.summaryText).y;
Style.set(this.sampleConnections,
'margin-top',

(5+a+5)+'px');}}});

/** js/connect_widget/connect_widget.js */
...
var g=DOM.scry(f,'span.total'),
h=DOM.scry(f,'div.grid_item');
if(h.length>1)
this.fan_hidden.push(h[1]);
...
this.popup_uri.addQueryData
({connect_id:this.profile_id,
popup:true});

Event.listen(this.button,'click',this.connectClickHandler.bind(this));}else 


Arbiter.subscribe('platform/like/connection',
this.updateWidgetFromLike.bind(this));
...
XD.init({channelUrl:this.channel_url});}
...
this.busy=true;
fbpage_set_fan_status(this.button,
this.profile_id,
true,
false,
this.connectDoneHandler.bind(this),
this.connectErrorHandler.bind(this),
this.getAsyncData());}};
...
false,
false,
this.connectUndoneHandler.bind(this),
function(){},
this.getAsyncData());}};
...
is_connect:ConnectWidget.is_connect,
fan_origin:'external_connect'};
if(Env.fb_dtsg)
a.fb_dtsg=Env.fb_dtsg;
...
window.open(this.popup_uri.toString(),
'_blank',
'toolbar=0,status=0,width=626,height=400');};
...
var c=DOM.find(this.user_profile,'img'),
d=DOM.find(this.user_profile,'a'),
e=DOM.find(this.user_profile,'div.name');
...
this.viewer_id=0;
this.popUpLogin();}else
if(a.error==1357013){
CSS.hide(this.button);
var b=
DOM.create('a',{href:DOM.find(document,'div.name_block a').href,
target:'_blank'},
"Verification is needed to connect.");
this.status=DOM.create('span',{className:'connect_span'},
b);

DOM.insertAfter(this.button,this.status);}else{
...
this.status=DOM.create('span',{className:'connect_span'},
HTML(b.feedback));
var c=DOM.create('a',{className:'undo'},
"Undo");
...
new AsyncRequest().
setMethod('GET').
setURI('/ajax/connect/connect_widget.php').
setData({id:a,uniqid:b,force_wall:c}).
setReadOnly(true).
...
/** js/connect_widget/like_widget.js */
...
Event.listen(this.unactionLink,'click',
this.connectToNodeOnClick.bind(this));
...
copyProperties(ExternalPageLikeWidget.prototype,
...
if(this.hasShowedInsights||(!this.pageId&&!this.domainId))
return;


var a=DOM.scry(this.widget,
'a.connect_widget_insights_link');
if(a)
for(var b=0;b<a.length;b++){
CSS.show(a[b].parentNode);
Event.listen(a[b],
'click',
this.presentInsightsPage.bind(this));}
...
function fbpage_set_fan_status(a,
b,
c,
d,
e,
...
var i=new AsyncRequest().
setURI('/ajax/pages/fan_status.php').
setData(h).
...
f=new AsyncRequest().
setMethod('POST').
setURI('/ajax/pages/favorite_status.php').
setData(e);
...
if(b.reload){
fbpage_reload_on_fan_status_changed(b.preserve_tab);}else 

fbpage_redraw_on_fan_status_changed(a,b.feedback);}
...
if(Parent.byClass(a,'fbTimelineEscapeSectionItem'))
a=Parent.byClass(a,'fan_status_inactive')||a;
...
var c=$('liked_pages_like_action_'+a),
d=$('liked_pages_undo_action_'+a);
...
if(window.PageLikeButton)
if(b){
PageLikeButton.informLike(a);
PageLikeButton.informLikeSuccess(a);}else 

PageLikeButton.informUnlike(a);}
...
if(m.require){
m.require('Arbiter').inform(h,i,j);}else
if(m.AsyncLoaderLazy)


m.AsyncLoaderLazy.wakeUp(h,i,j);}catch(
