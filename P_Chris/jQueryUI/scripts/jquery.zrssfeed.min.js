                    ...
                    if (j = f.feed) {
                        ...
                        for (f = e.offset; f < j.entries.length; f++) {
                            ...
                            case "timeline":
                                ...
                                break;
                            default:
                                a = b, b = new Date(a), a = e.dateformat, a = a.replace("dd", n(b.getDate())), a = a.replace("MM", n(b.getMonth() + 1)), a = a.replace("yyyy", b.getFullYear()), a = a.replace("hh", n(b.getHours())), a = a.replace("mm", n(b.getMinutes())), a = a.replace("ss", n(b.getSeconds()))
                            }
