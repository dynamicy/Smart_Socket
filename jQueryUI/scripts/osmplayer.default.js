(function (a, b) {
    ...
    b.playLoader[a].prototype.getDisplay = function () {
        this.options.build && jQuery(".minplayer-" + a + "", this.context).prepend('      <div class="minplayer-' + a + '-loader-wrapper">        <div class="minplayer-' + a + '-big-play ui-state-default"><span></span></div>        <div class="minplayer-' + a + '-loader">&nbsp;</div>        <div class="minplayer-' + a + '-preview ui-widget-content"></div>      </div>');
        return jQuery(".minplayer-" + a + " .minplayer-" + a + "-loader-wrapper", this.context)
    };
    b.playLoader[a].prototype.loadPreview = function () {
        minplayer.playLoader.prototype.loadPreview.call(this) || this.elements.preview.addClass("no-image")
    };
...
(function (a, b) {
    ...
    b.controller[a].prototype.construct = function () {
        ...
        !this.options.volumeVertical || this.options.controllerOnly ? (this.display.addClass("minplayer-controls-volume-horizontal"), this.display.removeClass("minplayer-controls-volume-vertical"), this.volumeBar.slider("option", "orientation", "horizontal")) : (this.display.addClass("minplayer-controls-volume-vertical"), this.display.removeClass("minplayer-controls-volume-horizontal"));
        this.options.controllerOnly || this.get("player", function (a) {
            this.get("media", function (b) {
                b.hasController() ? a.display.addClass("with-controller") : this.showThenHide(5E3, function (b) {
                    a.display[b ? "addClass" : "removeClass"]("with-controller")
                })
            })
        })
    };
    b.controller[a].prototype.getDisplay =
    ...
    b.controller[a].prototype.getElements = function () {
        var b = minplayer.controller.prototype.getElements.call(this),
            c = jQuery(".minplayer-" + a + "-timer", this.display);
        return jQuery.extend(b, {
    ...
    b.playlist[a].prototype.construct = function () {
        ...
        this.get("player", function (a) {
            var b = this.options.vertical ? "width" : "height",
                e = this.options.vertical ? "right" : "bottom",
                g = this.options.vertical ? "marginRight" : "marginBottom";
            this.hideShow = function (f, j) {
                var h = {},
                    i = {},
                    k = this.display[b](),
                    l = this.options.vertical ? "e" : "s",
                    m = this.options.vertical ? "w" : "n";
                jQuery("span", this.elements.hideShow).removeClass(f ? "ui-icon-triangle-1-" + m : "ui-icon-triangle-1-" + l).addClass(f ? "ui-icon-triangle-1-" + l : "ui-icon-triangle-1-" + m);
                h[e] = f ? k : 0;
                a.elements.minplayer && (j ? a.elements.minplayer.animate(h, "fast") : a.elements.minplayer.css(h));
                i[g] = f ? 0 : -k;
                j ? this.display.animate(i, "fast", function () {
                    a.resize()
                }) : this.display.css(i)
            };
            ...
            this.elements.hideShow && this.elements.hideShow.bind("click", function (a) {
                return function (b) {
                    b.preventDefault();
                    b = jQuery("span", a.elements.hideShow).hasClass("ui-icon-triangle-1-" + (a.options.vertical ? "w" : "n"));
                    a.hideShow(b, !0)
                }
            }(this));
            a.elements.minplayer && (this.options.showPlaylist ? this.options.vertical ? a.elements.minplayer.css("right", this.display.width() + "px") : a.elements.minplayer.css("bottom", this.display.height() + "px") : this.hideShow(!1))
        })
    };
    b.playlist[a].prototype.getDisplay = function () {
        this.options.build && this.context.append('      <div class="osmplayer-' + a + '-playlist">        <div class="osmplayer-' + a + '-hide-show-playlist ui-state-default">          <span class="ui-icon"></span>        </div>        <div class="minplayer-' + a + '-loader-wrapper">          <div class="minplayer-' + a + '-loader"></div>        </div>        <div class="osmplayer-' + a + '-playlist-scroll ui-widget-content">          <div class="osmplayer-' + a + '-playlist-list"></div>      </div>      </div>');
        return jQuery(".osmplayer-" + a + "-playlist", this.context)
    };
    b.playlist[a].prototype.getElements = function () {
        var d = b.playlist.prototype.getElements.call(this),
            c = this.options.vertical ? "playlist-vertical" : "playlist-horizontal",
            c = c + (this.options.playlistOnly ? " playlist-only" : ""),
            e = this.options.showPlaylist,
            e = this.options.vertical ? e ? "e" : "w" : e ? "s" : "n",
            g = this.options.vertical ? "ui-corner-left" : "ui-corner-top";
        (this.options.disablePlaylist || !this.options.playlist) && this.display.remove();
        this.display.addClass(c);
        c = jQuery(".osmplayer-" + a + "-hide-show-playlist", this.display);
        c.addClass(g);
        this.options.playlistOnly && (c.hide(), c = null);
        jQuery("span", c).addClass("ui-icon-triangle-1-" + e);
...
(function (a, b) {
    ...
    b.teaser[a].prototype.getDisplay =

    function () {
        this.context.append('    <div class="osmplayer-' + a + '-teaser ui-widget-content">      <div class="osmplayer-' + a + '-teaser-image"></div>      <div class="osmplayer-' + a + '-teaser-info ui-state-default">        <div class="osmplayer-' + a + '-teaser-title">Sample Title</div>      </div>    </div>');
    ...
    b.teaser[a].prototype.getElements = function () {
        var d = b.teaser.prototype.getElements.call(this);
        return jQuery.extend(d, {
...
(function (a, b) {
    ...
    b.pager[a].prototype.getDisplay = function () {
        ...
        return jQuery(".osmplayer-" + a + "-playlist-pager", this.context)
    };
    b.pager[a].prototype.getElements = function () {
        var d = b.pager.prototype.getElements.call(this);
        return jQuery.extend(d, {
...
(function (a, b) {
    ...
    b[a].prototype.construct = function () {
        ...
        this.options.controllerOnly && this.display.addClass("controller-only")
    };
    b[a].prototype.getDisplay = function () {
        0 == this.context.children().length && (this.context = this.context.attr({
        ...
        })).parent(".osmplayer-" + a), this.options.build = !0);
        return this.context
    };
    b[a].prototype.getElements = function () {
        var d = b.prototype.getElements.call(this);
        this.display.width(this.options.width);
        this.display.height(this.options.height);
        var c = jQuery(".minplayer-" + a, this.display);
        this.options.playlistOnly && (c.remove(), c = null);
        return jQuery.extend(d, {
            player: this.display,
            minplayer: c,
